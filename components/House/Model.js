...
const map = [
  ...
  { name: "door", visible:true, mat: {color: "#969696", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "og", visible:true, mat: {color: "#ffffff", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "og_fl", visible:true, mat: {color: "#ffffff", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "og_bottom_fl", visible:true, mat: {color: "#ffffff", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "dach_wire", visible:true, mat: {color: "#ffffff", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "dach_innen_fl", visible:true, mat: {color: "#ffffff", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "dach_außen_fl", visible:true, mat: {color: "#454141", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
  { name: "geländer", visible:true, mat: {color: "#414141", opacity_default:1, opacity_inactive:.3, opacity_active: 1} },
